...
if page == "Home":
    ...
    if uploaded_image is not None:
        ...
        st.image("Germain.jpg", width=100, caption="Default Image")
...
# Projects section
    ...
    with st.expander("🤖 Online hotel booking System"):
        st.write("Developed  using PHP And Database")
       

    with st.expander("🌐 AI Based Dissertation monitaring System"):
